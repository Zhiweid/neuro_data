...
class DatasetConfig(ConfigBase, dj.Lookup):
    ...
    # @h5cached(
    #     "/dj-stor01/cache/foundation-dynamic-static",
    #     mode="array",
    #     transfer_to_tmp=False,
    #     file_format="foundation-dynamic-static-{dynamic_animal_id}-{dynamic_session}-{dynamic_scan_idx}-{static_animal_id}-{static_session}-{static_scan_idx}-{dataset_hash}.h5",
    # )
    # class FoundationDvStaticNoBeh(dj.Part):
    ...
    #     -> master
    #     ---
    #     -> StaticScan.proj(dynamic_animal_id='animal_id', dynamic_session='session', dynamic_scan_idx='scan_idx')
    ...
    #         return requests.FoundationDynamicStaticNoBehRequest
    ...
    #         # responses = virtual_data_schemas.FoundationInputResponse().reorder_responses(key, condition_hashes)
    ...
    #         responses = (virtual_data_schemas.FoundationInputResponse.ResponseBlock & key).fetch1('responses')[order, :]
    #         dynamic_unit_keys = (virtual_data_schemas.FoundationInputResponse.ResponseKeys & key).fetch(as_dict=True, order_by='col_id')
